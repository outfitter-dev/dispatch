...
provider request. This adds schema version 26; an older executable cannot open
that upgraded Registry. Rows created before version 26 have no submitted-intent
